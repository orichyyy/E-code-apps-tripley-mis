...
- `apps/web`: React Vite SPA admin shell using TanStack Router, TanStack Query, TanStack Form, Zod, Zustand, Tailwind CSS, and shadcn/ui, including base file metadata, announcement, in-app notification, i18n message, notification template, and webhook subscription management pages.
