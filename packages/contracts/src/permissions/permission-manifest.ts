...
export const basePermissionManifest: PermissionManifestEntry[] = [
  ...
  {
    code: "organization:depth:configure",
    description: "Configure organization max depth",
  ...
  { code: "announcement:update", description: "Update announcements", module: "announcements" },
  {
    ...
    description: "Publish or unpublish announcements",
  ...
  {
    code: "import-export:create",
    description: "Create CSV import/export tasks",
