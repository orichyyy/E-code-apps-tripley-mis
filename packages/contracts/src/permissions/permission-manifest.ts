...
export const basePermissionManifest: PermissionManifestEntry[] = [
  ...
  { code: "system-config:view", description: "View system configuration", module: "system-config" },
  { code: "system-config:update", description: "Update system configuration", module: "system-config" },
  { code: "dictionary:view", description: "View dictionaries", module: "dictionaries" },
  { code: "dictionary:create", description: "Create dictionary records", module: "dictionaries" },
  ...
  { code: "file:upload", description: "Upload files", module: "files" },
  { code: "file:download", description: "Download files", module: "files" },
  { code: "file:preview", description: "Preview image files", module: "files" },
  { code: "file:references:view", description: "View file references", module: "files" },
  ...
  { code: "announcement:view", description: "View announcements", module: "announcements" },
  { code: "announcement:create", description: "Create announcements", module: "announcements" },
  { code: "announcement:update", description: "Update announcements", module: "announcements" },
  { code: "announcement:publish", description: "Publish or unpublish announcements", module: "announcements" },
