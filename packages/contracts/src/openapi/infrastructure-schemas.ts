...
export const infrastructureComponentSchemas: OpenApiDocument["components"]["schemas"] = {
  ...
  EmailDelivery: {
    ...
    properties: {
      ...
      status: enumSchema(["pending", "running", "succeeded", "failed", "canceled"]),
      attempt: { type: "integer" },
      maxAttempts: { type: "integer" },
      createdAt: dateTimeSchema,
      updatedAt: dateTimeSchema,
      succeededAt: nullableDateTimeSchema,
      failedAt: nullableDateTimeSchema,
      canceledAt: nullableDateTimeSchema,
      contentPurgedAt: nullableDateTimeSchema,
    },
    additionalProperties: false,
  },
  EmailDeliveryAttempt: {
    ...
    properties: {
      ...
      smtpCode: { type: "integer", nullable: true },
  ...
  EmailDeliveryDetail: {
    allOf: [
      { $ref: "#/components/schemas/EmailDelivery" },
      {
        ...
        properties: {
          referenceType: nullableStringSchema,
          referenceId: nullableStringSchema,
          lastSmtpCode: { type: "integer", nullable: true },
          lastErrorCode: nullableStringSchema,
          lastErrorMessage: nullableStringSchema,
          attempts: { type: "array", items: { $ref: "#/components/schemas/EmailDeliveryAttempt" } },
        },
      },
    ],
  },
  ...
  EmailDeliveryListResponse: envelopeSchema({
    type: "object",
    required: ["items", "total", "page", "pageSize"],
    properties: {
      items: { type: "array", items: { $ref: "#/components/schemas/EmailDelivery" } },
      total: { type: "integer" },
      page: { type: "integer" },
  ...
  EmailDeliveryDetailResponse: nullableEntityEnvelope("EmailDeliveryDetail"),
