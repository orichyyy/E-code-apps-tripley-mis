...
export const baseApiPermissionManifest: BaseApiPermissionManifestEntry[] = [
  ...
  },
  {
    ...
    code: "api.announcements.current",
    description: "View announcements for the current organization",
    module: "announcements",
    logLevel: "basic",
    public: false,
  },
  ...
  },
  {
    method: "DELETE",
    path: "/api/announcements/:id",
    code: "api.announcements.delete",
    description: "Delete draft announcement",
    module: "announcements",
  ...
  },
  {
    ...
    code: "api.modules.registry.view",
    description: "View Business Module release and accepted registry state",
  ...
  {
    method: "POST",
    path: "/api/modules/sync/plan",
    code: "api.modules.sync.plan",
    description: "Build a read-only Business Module sync plan",
    module: "module-registry",
    requiredPermission: "module-registry:view",
    logLevel: "basic",
    public: false,
  ...
  {
    method: "POST",
    path: "/api/modules/sync/apply",
    code: "api.modules.sync.apply",
    description: "Confirm and apply a Business Module sync plan",
    module: "module-registry",
