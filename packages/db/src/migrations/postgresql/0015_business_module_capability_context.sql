...
ALTER TABLE import_export_tasks ADD COLUMN request_json JSONB NOT NULL DEFAULT '{}'::jsonb;
ALTER TABLE import_export_tasks ADD COLUMN execution_context_json JSONB;
